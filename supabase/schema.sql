...
ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS email_sequence_step INTEGER DEFAULT 0 NOT NULL;
ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS unsubscribed BOOLEAN DEFAULT false NOT NULL;
