    ...
    <div className="min-h-screen bg-slate-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-gray-100">
        <div className="mb-10 text-center">
          <Link href="/" className="inline-flex items-center justify-center text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors mb-6">
        ...
        <div className="grid gap-8 mb-10">
          <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100">
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium">QR-Crave<br />Srinagar, Jammu & Kashmir<br />India - 190001</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100">
            ...
            <div>
              ...
              <a href="mailto:support@vionys.com" className="text-blue-600 hover:underline font-medium">support@vionys.com</a>
            </div>
          </div>
